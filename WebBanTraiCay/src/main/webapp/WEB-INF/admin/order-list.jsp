...
<div style="display:none;" id="myDiv" class="animate-bottom">
    ...
    <section class="home-section">
        ...
        <div class="find-product">
            <form action="${pageContext.request.contextPath}/admin/order/order-list-controller?index=1"
                  method="post">
                <div class="fill-product">
                    <input id="find-product" type="text" placeholder="Tìm kiếm tên khách hàng"
                           name="txtSearch">
                    <button>
            ...
            <div class="pagination">
                ...
                <c:if test="${pageId== 1 && haveMaxPage ==1}">
                    ...
                    <c:forEach begin="1" end="${haveMaxPage}" var="i">
                        <a id="${i}"
                           href="${pageContext.request.contextPath}/admin/order/order-list?pageId=${i}">${i}</a>
                    </c:forEach>
                    <a>&raquo;</a>
                </c:if>
