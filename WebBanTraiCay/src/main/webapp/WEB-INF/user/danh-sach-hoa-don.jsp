...
<head>
    ...
    <link rel="stylesheet"
          href="${pageContext.request.contextPath}/static/css/user-css/ds-hoa-don.css">
</head>
                    ...
                    <c:forEach items="${listBills}" var="bill" varStatus="loopStatus">
                        <tr>
                            ...
                            <c:if test="${bill.getStatus() eq 'Đã hủy'}">
                                <td>
                                    <a style="text-decoration: none; display: inline-block;width: 130px;height: 50px;background-color: #a2a998; color: white;padding: 10px;box-sizing: border-box"
                                       href="#">
                                        Đã hủy
                                    </a>
                                </td>
                            ...
                            <c:if test="${bill.getStatus() ne 'Đã hủy'}">
                                <td>
                                    <a style="text-decoration: none; display: inline-block;width: 130px;height: 50px;background-color: #82ae46; color: white;padding: 10px;box-sizing: border-box"
                                       href="${pageContext.request.contextPath}/page/bill/cancel-bill?idBill=${bill.getId()}&status=daHuy">
                                        Hủy đơn hàng
                                    </a>
                                </td>
                            </c:if>
