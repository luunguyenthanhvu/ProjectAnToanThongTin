...
<head>
    ...
    <link rel="stylesheet"
          href="${pageContext.request.contextPath}/static/css/user-css/update-pass.css">
</head>
    ...
    <div class="container">
        ...
        <div class="container-child-right">
            ...
            <form class="change-password"
                  action="${pageContext.request.contextPath}/page/user/update-pass" method="post">
                <table style="border-collapse:collapse;
                    border: none; ">
                    <tr>
                        <td>
                            <label for="old-password">Mật khẩu cũ<span
                                    class="not-empty"> *</span></label>
                        </td>
                        <td>
                            <input type="password" id="old-password" name="old-password"
                                   value="${oldPass}">
                            <span class="error-msg required" id="old-password-error"
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="password" id="new-password" name="new-password"
                                   value="${newPass}">
                            <span class="error-msg required" id="new-password-error"
                                  style="display: none;"></span>
                    ...
                    <tr>
                        <td>
                            <label for="retype-password">Nhập lại mật khẩu mới<span
                                    class="not-empty"> *</span></label>
                        </td>
                        <td>
                            <input type="password" id="retype-password" name="retype-password"
                                   value="${retypePass}">
                            <span class="error-msg required" id="retype-password-error"
                                  style="display: none;"></span>
                            <span class="error-msg required" id="retype-mismatch-error"
                                  style="display: none;"></span>
