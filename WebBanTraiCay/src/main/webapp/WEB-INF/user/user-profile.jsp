        ...
        <div class="container-child-right">
            ...
            <div class="user-profile" style="margin-right: 50px">
                <div class="user-basic-info">
                    ...
                    border: none; ">
                        <tr>
                            <td><label for="ten_nd">Tên người dùng <span style="color: red">*</span></label>
                            </td>
                        ...
                        <tr>
                            ...
                            <td><span style="position: relative; top: -5px; margin-left: 80px"
                                      id="email_nd" type="text">${user.getEmail()}
                            </span></td>
                        </tr>
                        <td><br></td>
                        ...
                        <tr>
                            <td><label for="gender">Giới tính <span
                                    style="color: red">*</span></label></td>
                            <td><span style="position: relative; top: -5px; margin-left: 80px"
                                      id="gender">${user.getSexual()}</span></td>
                        </tr>
                        <td><br></td>
                        <tr>
                            <td><label for="dc_nd">Địa chỉ <span style="color: red">*</span></label>
                            </td>
                            <td><span style="position: relative; top: -5px;margin-left: 80px"
                                      id="dc_nd" type="text">${user.getAddress()}</span></td>
                        </tr>
                        <td><br></td>


                        <tr>
                            <td><label for="sdt_nd">Số điện thoại <span style="color: red">*</span></label>
                            </td>

                            <td><span style="position: relative; top: -5px;margin-left: 80px"
                                      id="sdt_nd">${user.getPhoneNumber()}</span></td>
                        </tr>
                        <td><br></td>
                        <tr>
                            ...
                            <td><span style="position: relative; top: -5px;margin-left: 80px"
                                      id="sn_nd"> ${user.getDateOfBirth()}</span></td>
