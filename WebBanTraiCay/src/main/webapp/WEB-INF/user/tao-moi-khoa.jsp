...
<head>
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/static/css/user-css/tao_khoa_moi_cho_nguoi_dung.css?=9">
...
<div class="main-user-content" style="background-color: #e7e6e6; width: 100%">
  <div class="rootContainer">
    <div class="containerCreateKey">
      ...
      <form action="${pageContext.request.contextPath}/page/user/create-a-key-pair-for-user" method="post">
