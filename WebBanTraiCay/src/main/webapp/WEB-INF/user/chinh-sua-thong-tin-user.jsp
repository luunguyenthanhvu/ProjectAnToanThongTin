...
<head>
    ...
    <link rel="stylesheet"
          href="${pageContext.request.contextPath}/static/css/user-css/chinh_sua_thong_tin.css">
</head>
    ...
    <div class="container">
        ...
        <div class="container-child-right">
            ...
            <form class="update-info"
                  action="${pageContext.request.contextPath}/page/user/update-info" method="post"
                ...
                <div class="user-info">
                    <div class="basic-info">
                        <table style="border-collapse:collapse;
                            border: none; ">
                            <tr>
                                <td><label for="id">ID <span style="color: red">*</span></label>
                                </td>
                                <td>
                                    <input style="margin-left: 60px; width: 250px" type="text"
                                           id="id" name="id"
                                           value="${user.getId()}"
                                           readonly>
                                </td>
                            ...
                            <tr>
                                <td><label for="ten_nd">Tên người dùng <span
                            ...
                            <tr>
                                <td><label for="email_nd">Email <span
                                        style="color: red">*</span></label></td>
                                <td>
                                    <input style="margin-left: 60px; width: 250px"
                                           name="email_nguoi_dung" id="email_nd"
                                           type="email"
                                           value="${user.getEmail()}">
                            ...
                            <tr>
                                <td><label for="gioi_tinh_nd">Giới tính <span
                                        style="color: red">*</span></label></td>
                                <td class="gender-td" id="gioi_tinh_nd">
                                    <c:choose>
                                        <c:when test="${not empty user.getSexual() and user.getSexual().equals('Nam')}">
                                            ...
                                            <input style="margin-left: 60px" type="radio" id="male"
                                                   name="gender"
                                                   value="Nam" checked>
                            ...
                            <tr>
                                <td><label for="dc_nd">Địa chỉ <span
                                        style="color: red">*</span></label></td>
                                <td>
                                    <input style="margin-left: 60px; width: 250px"
                                           name="dia_chi_nguoi_dung" id="dc_nd"
                                           type="text"
                            ...
                            <tr>
                                <td><label for="sdt_nd">Số điện thoại <span
                                        style="color: red">*</span></label></td>
                                <td><input style="margin-left: 60px; width: 250px"
                                           name="so_dien_thoai_nguoi_dung"
                                           id="sdt_nd"
                            ...
                            <tr>
                                <td><label for="dob">Sinh nhật<span
                                        class="not-empty"> *</span></label></td>
                                <td>
                                    <input style="margin-left: 60px; width: 250px" type="date"
                                           id="dob" name="dob"
                    ...
                    <div class="user-img">
                        <c:choose>
                            <c:when test="${not empty user.getImg()}">
                                ...
                                <img style="width: 170px; height:170px; object-fit:cover"
                                     id="previewImage" src="${user.getImg()}" alt="">
                            </c:when>
                            <c:otherwise>
                                <!-- Ảnh mặc định khi mới đăng ký -->
                                <img style="width: 170px; height:170px; object-fit:cover"
                                     id="previewImage"
                                     src="${pageContext.request.contextPath}/static/images/accountPicture.png"
                                     alt="">
                            </c:otherwise>
                        </c:choose>
