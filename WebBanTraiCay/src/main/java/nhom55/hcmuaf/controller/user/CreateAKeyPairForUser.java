    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
       try{
           ...
           if(!isVerified){
              ...
              publicKeyObj.setKey(publicKey);
              publicKeyObj.setCreateAt(timeCreated);
...
//               Viết log public Key được tạo
               ...
               publicKeyLog.setLevel(LogLevels.ALERT);
               publicKeyLog.setNote(String.valueOf(LogNote.INSERT_PUBLIC_KEY));
               publicKeyLog.setCurrentValue(MyUtils.convertToJson(publicKeyObj));
